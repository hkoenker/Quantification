...
:::
::: {.column}
- Panel A: Country-specific estimated median lifespan from Malaria Atlas Project (MAP) [@10.1038/s41467-021-23707-7], compared to estimated median lifespans from ITN durability monitoring (DM) activities [@Abilio:2020fl; @Kilian:2020dj; @Mansiangi:2020cv; @Haji:2020de; @Obi:2020eza; @Kilian:2015hk; @10.1371/journal.pmed.1003248; @Randriamaherijaona:2017fo]. 
- Panel B shows net decay functions rely on smooth-compact loss function developed by Nakul Chitnis [@Koenker:2013ed; @Bhatt:2015gn; @10.1186/s12936-022-04272-w]
...
:::::::::::::: {.columns}
::: {.column}
![Percent difference in total nets needed by scenario](figs/Fig_avgtotalnets.png)

:::
::: {.column}
![](figs/Fig_facettotalnets.png)
:::
::::::::::::::
