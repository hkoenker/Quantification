...
```{r geo_facets_3ucc, warning = FALSE, message=FALSE, fig.width = 7, fig.height = 6, fig.topcaption=TRUE, out.width="80%", fig.cap = "\\label{geo_facets_3ucc}ITN access estimated for 3-year mass campaign strategy, with ANC/EPI distribution at 6% of the population annually"}
...
```{r geo_facets_cducc, warning = FALSE, message=FALSE, fig.width = 7, fig.height = 6, fig.topcaption=TRUE, out.width="80%", fig.cap = "\\label{geo_facets_cducc}Scenario 3 - three-year mass campaigns with ANC/EPI distribution at 6%, and between-campaign continuous distribution at 10%"}
...
```{r kable_table80, include=FALSE}
table80 %>% 
  select(-scenario_1) %>% 
  kbl(format = "latex", col.names = c("Country","Full-scale continuous + routine","Campaign + routine + continuous between campaigns","3-yearly campaigns","2-yearly campaigns"), 
      caption="Summary of recommended quantifiers for scenarios, to maintain ITN access at or above 80%") %>%
...
```{r fig_school, fig.width = 7, fig.height = 6, fig.topcaption=TRUE, out.width="80%", fig.cap = "\\label{fig_school}Feasibility of large-scale annual school distribution to achieve ITN access targets"}
