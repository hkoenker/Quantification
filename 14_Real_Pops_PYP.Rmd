...
print(pypplot)
  plotname <- paste("figs/pyp/pyp_",iso3,".pdf", sep = "")
  ggsave(plotname)
...
Note: all countries use World Bank population projections, but do not account for areas where people are not at risk of malaria, or subnational tailoring of ITN strategies.
